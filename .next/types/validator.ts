...
// Validate ../../src/app/api/generate-pathways/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/generate-pathways">> = Specific
  const handler = {} as typeof import("../../src/app/api/generate-pathways/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
